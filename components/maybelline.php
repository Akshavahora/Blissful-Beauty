...
$sel = "SELECT * FROM product p INNER JOIN product_shades ps ON p.P_Id = ps.product_id WHERE p.P_Category = 'Maybelline' ORDER BY p.P_Id DESC;";
$res = mysqli_query($conn, $sel);
?>

<!-- Hero/Banner Section -->
<section class="relative h-72 flex items-center justify-center bg-cover bg-center mb-8" style="background-image: url('../Images/brands/Maybelline-Logo.png');">
    <div class="absolute inset-0 bg-black opacity-70"></div>
    <div class="absolute inset-0 bg-gradient-to-br from-black/40 via-transparent to-gray-900/60 animate-gradient-move"></div>
    <div class="relative z-10 text-center">
        <h1 class="text-5xl md:text-6xl font-extrabold text-white drop-shadow-lg mb-2 animate-fade-in">Maybelline</h1>
        <p class="text-lg text-gray-200 animate-fade-in delay-200 mb-4">Express yourself with Maybelline – bold colors, innovative formulas, and effortless beauty for every day.</p>
        <a href="#Products" class="inline-block bg-black text-white text-lg font-semibold px-8 py-3 rounded-lg shadow-lg hover:bg-gray-900 transition-all duration-200 animate-fade-in-up">Shop All <i class="fa fa-arrow-down ml-2"></i></a>
    </div>
</section>

<section class="Products px-4 md:px-36 pt-6 pb-16 bg-gradient-to-br from-white via-gray-100 to-gray-200 animate-fade-in-up" id="Products">
    ...
    <!-- Back to Top Button -->
    <button id="backToTopBtn" class="fixed bottom-8 right-8 z-50 bg-black text-white p-4 rounded-full shadow-lg hover:bg-gray-900 transition-all duration-200 hidden"><i class="fa fa-arrow-up"></i></button>
</section>
