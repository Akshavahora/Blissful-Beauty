      ...
      <div class="relative">
        ...
        <div id="userDropdownMenu" class="hidden absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg">
          ...
          if (isset($_SESSION['Id'])) {
            echo "
            <a href='log_out.php' class='block px-4 py-2'>Logout</a>
            <a href='my_profile.php'class='block px-4 py-2'>My Profile </a> 
            <a href='my_orders.php'class='block px-4 py-2'>My Orders </a> ";
          } else {
