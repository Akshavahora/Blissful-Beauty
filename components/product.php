            ...
            <div class="w-full md:w-1/2 flex flex-col justify-center mt-6 md:mt-0">
                ...
                <div class="mt-4">
                    ...
                    <div class="flex flex-wrap mt-2 gap-2" id="shade-swatches">
                        ...
                        ?>
                            <div class="group relative border-2 border-gray-300 transition-all duration-200 hover:shadow-md cursor-pointer rounded-full w-12 h-12 flex items-center justify-center hover:ring-2 hover:ring-teal-300 focus:outline-none"
                                ...
                                tabindex="0">
                                <span class="hidden group-hover:block absolute left-1/2 -translate-x-1/2 -bottom-8 bg-white text-teal-600 px-3 py-1 rounded-lg text-sm shadow-[0_2px_8px_rgba(0,0,0,0.08)] z-10 whitespace-nowrap"><?php echo $colorName; ?></span>
