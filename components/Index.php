...
<body class="bg-gradient-to-br from-white via-gray-50 to-teal-50">
    ...
    WHERE FIND_IN_SET('Swiper', p.filter_name)
    ...
    <!-- ================= HOME SLIDER SECTION ================= -->
    <section class="home px-4 md:px-36 bg-gradient-to-br from-pink-50 via-white to-pink-100 py-16 rounded-3xl shadow-md mb-16">
