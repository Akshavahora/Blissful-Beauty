...
$sel = "SELECT *
FROM product p
INNER JOIN product_shades ps ON p.P_Id = ps.product_id
GROUP BY p.P_Id
...
<!-- Hero/Banner Section -->
<section class="relative h-64 flex items-center justify-center bg-cover bg-center mb-8" style="background-image: url('../Images/Slider-Images/Slider-03.jpg');">
    <div class="absolute inset-0 bg-black opacity-50"></div>
    <div class="relative z-10 text-center">
        <h1 class="text-5xl md:text-6xl font-extrabold text-white drop-shadow-lg mb-2 animate-fade-in">Shop</h1>
        <p class="text-lg text-gray-200 animate-fade-in delay-200">Discover our latest products and offers</p>
    </div>
</section>

<section class="Products px-4 md:px-36 pt-6 pb-16 bg-gradient-to-br from-white via-gray-50 to-teal-50 animate-fade-in-up" id="Products">
    ...
    <div id="noProductMessage" class="flex flex-col items-center justify-center text-center text-red-500 text-xl hidden mt-12 animate-fade-in-up">
