...
$sel = "SELECT * FROM product p INNER JOIN product_shades ps ON p.P_Id = ps.product_id WHERE p.filter_name = 'Top-rated' ORDER BY p.P_Id DESC;";
...
<section class="relative h-72 flex items-center justify-center bg-gradient-to-br from-teal-100 via-white to-teal-200 mb-8">
    <div class="absolute inset-0 bg-gradient-to-br from-black/20 via-transparent to-teal-300/30 animate-gradient-move"></div>
    <div class="relative z-10 text-center">
        <h1 class="text-5xl md:text-6xl font-extrabold text-black drop-shadow-lg mb-2 animate-fade-in">Top-rated</h1>
        <p class="text-lg text-teal-700 animate-fade-in delay-200 mb-4">Our most loved products, rated by real customers!</p>
